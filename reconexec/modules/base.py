"""Base module interface definition for ReconExec data collectors."""

from __future__ import annotations

from abc import ABC, abstractmethod
from typing import Any, Dict, List, Optional
from reconexec.core.models import Finding
from reconexec.utils.http import AsyncHTTPClient, http_client


class BaseModule(ABC):
    """Abstract Base Class for all ReconExec collection and enrichment modules."""
