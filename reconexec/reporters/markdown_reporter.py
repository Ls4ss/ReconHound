"""Executive Markdown Reporter for ReconExec Scans."""

from __future__ import annotations

from pathlib import Path
from typing import Dict, List, Set
from reconexec.core.models import FindingType, ScanResult, SeverityLevel
...
class MarkdownReporter:
    ...
    def generate(cls, result: ScanResult) -> str:
        ...
        lines.append("---")
        lines.append("*Generated automatically by ReconExec-CLI v2.0 — Modern EASM & Threat Intelligence Engine.*  ")
        lines.append("*Powered by [ReconExec Security](https://reconexec.com.br)*")
