...
from reconexec.web.api.routes import router as api_router
from reconexec.web.api.auth import router as auth_router, get_current_user
from jose import jwt, JWTError
from reconexec.web.api.auth import SECRET_KEY, ALGORITHM, get_config_db
...
def create_app(db_path: str = None) -> FastAPI:
    ...
    async def serve_dashboard(request: Request):
        ...
        token = request.cookies.get("reconexec_token")
        authenticated = False
        if token:
            try:
